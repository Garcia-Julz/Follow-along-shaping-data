...
// ***********************************************************
// ** Below is the method to have a filter of NY businesses **
// ***********************************************************
...
//         inNewYork = true
//     }
//     // console.log("NY",newYorkBusinesses)

//     return inNewYork
// })

// ***********************************************************
// ** Below is the method to have a filter of manufacturing **
// ***********************************************************
...
//     }
//     // console.log("Manufacturing", ManufacturingBusinesses)

//     return ManufacturingIndustry
// })

// ***********************************************************************
// ** Below is the method to have a list of purchasing agents via map() **
// ***********************************************************************
...
// company name, and the phone number. The data structure is shown below. Use 
// that new data structure to display the agent with their company and phone 
// number
...
// ***************************************************************************
// ** Below is the forEach method to search for the objects inside the list **
// ***************************************************************************
...
// The filter function creates a new array from the existing one, so you can
// invoke it and assign it to a new variable such as in the code below. The
// function that you pass to filter() should return true or false. If it
// returns true, then the current item will be placed in the new array.
...
// **********************************************************************************
// ** Below is the maps() method used to create a new object to display the return **
// **********************************************************************************
...
// **********************************************************************************
// ** Below is the find method used to search an object to display on the console  **
// **********************************************************************************
...
// console.log("found candy", firstCheapCandy)

// ************************************************************************************************
// ** Below is the find method used to search an object in an array to show on the DOM via input **
// ************************************************************************************************
...
// ************************************************************************************************
// **          Below is the same as above, but used to find purchasing agents instead            **
// ************************************************************************************************


// Lightning Exercise 1: Refactor your code to search for purchasing agents instead. If the search text
// is found in the first name of any purchasing agent, show that agent.
...
//             const foundAgent = businesses.find(
//                 business =>
//                 business.purchasingAgent.nameLast.includes(keyPressEvent.target.value) || business.purchasingAgent.nameFirst.includes(keyPressEvent.target.value)
//             );
...
// Lightning Exercise 1: Use the reduce method on the following array to determine how much total rain 
// fell last month.
